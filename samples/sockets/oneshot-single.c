...
int main(int argc, char *argv[])
{
	...
	/* A sockaddr struct holds socket information for lots of different sockets.
	...
	*/
	...
	/* Make sure sin_zero is all zeroes */
	...
	/* Start listening. The second parameter is the "backlog", or the maximum number of
	   ...
	   Note that listen() doesn't block until incoming connections arrives. It just makes
	...
	/* Note that the above is a one-oneshot server. The program not only closes the connection
